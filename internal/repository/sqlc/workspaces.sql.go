...
SELECT id, name, slug, created_at, updated_at, deleted_at FROM workspaces
...
SELECT w.id, w.name, w.slug, w.created_at, w.updated_at, w.deleted_at FROM workspaces w
